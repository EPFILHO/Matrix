...
//|                     Versão 1.49 - Claude Parte 026 (Claude Code) |
//+------------------------------------------------------------------+
      ...
      if(g_panel != NULL)
        {
         ...
         if(!g_panel.CreatePanel(0, "EPBotMatrix - Versão 1.49", 0, x1, 20, x1 + PANEL_WIDTH, 20 + PANEL_HEIGHT))
           {
