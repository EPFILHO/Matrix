...
//|                      Estratégia RSI - EPBot Matrix Modular       |
//|                                                      Versão 2.01 |
//+------------------------------------------------------------------+
...
//+------------------------------------------------------------------+
//| Modo MIDDLE: Cruzamento da linha 50                              |
//+------------------------------------------------------------------+
...
//+------------------------------------------------------------------+
//| HOT RELOAD - Alterar linha média                                 |
//+------------------------------------------------------------------+
...
//+------------------------------------------------------------------+
//| HOT RELOAD - Alterar shift do sinal                              |
//+------------------------------------------------------------------+
...
string CRSIStrategy::GetSignalModeText()
{
   switch(m_signal_mode)
   {
      case RSI_MODE_CROSSOVER: return "Crossover";
      case RSI_MODE_ZONE:      return "Zone";
      case RSI_MODE_MIDDLE:    return "Middle";
